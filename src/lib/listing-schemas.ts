  ...
  mercari: {
    ...
    fields: [
      ...
      },
      {
        ...
        source: "description",
        maxLength: 1000,
        hint: "Mercari details (max ~1000 chars). Include fit, measurements, fabric, flaws, and smoke/pet notes. Use Write/Rewrite with AI after structured fields are set — Rewrite updates only changed facts and keeps your edits.",
  ...
  poshmark: {
    ...
    fields: [
      ...
      },
      {
        ...
        source: "description",
        maxLength: 5000,
        hint: "Poshmark details (up to ~5000 chars). Cover fit, flat measurements, fabric, flaws, and smoke/pet notes. Use Write/Rewrite with AI after structured fields are set — Rewrite updates only changed facts and keeps your edits.",
